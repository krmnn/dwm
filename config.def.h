...
static const char col_magenta[]        = "#94448B";
static const char *colors[][5]      = {
	/*               fg         bg         border   */
	[SchemeNorm]     = { col_gray, col_darkgray, col_gray2 },
	[SchemeSel]      = { col_white, col_blue,  col_red  },
    [SchemeBar]      = { col_darkgray, col_white,  col_white  },
    [SchemeTaskSel]  = { col_white, col_red,  col_red  },
    [SchemeTaskNorm] = { col_darkgray, col_gray,  col_gray2  },
    [SchemeLayout]   = { col_gray, col_magenta,  col_gray2  },
};
...
static const Rule rules[] = {
	...
	{ NULL,     NULL,          "gmail",    1 << 1,       0,           -1 },
	{ NULL,     NULL,       "chat",    1 << 1,       0,           -1 },
...
static Key keys[] = {
	...
	{ 0,                            XK_Home,   focusstack,     {.i = +1 } },
	{ MODKEY,                       XK_Home,   focusstack,     {.i = -1 } },
